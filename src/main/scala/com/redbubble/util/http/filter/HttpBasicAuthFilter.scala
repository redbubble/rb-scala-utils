...
/**
  ...
  */
abstract class HttpBasicAuthFilter(realm: String, credentials: BasicAuthCredentials, authenticatedPaths: Seq[String],
    statsReceiver: StatsReceiver) extends HttpFilter {
