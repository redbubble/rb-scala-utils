...
import com.redbubble.util.http.ErrorHandler
...
/**
  ...
  */
abstract class ExceptionFilter(encoder: Encode.Json[Throwable], errorHandler: ErrorHandler, statsReceiver: StatsReceiver)
    extends HttpFilter {
